 ...
 */
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(e){"object"===("undefined"==typeof exports?"undefined":_typeof(exports))&&"object"===("undefined"==typeof module?"undefined":_typeof(module))?module.exports=e():"function"==typeof define&&define.amd?define(e):window.smartNumberInputs=e()}(function(){var e=function(e){return"[object Array]"===Object.prototype.toString.call(e)},t=function(e,t,n){return e.addEventListener(t,n)},n=function(e,t){for(var n=0;n<e.length;n++)t(e[n])},o=38,r=40,i=/([^\-\w0-9]+)/,u=function(e){if(e.which===o||e.which===r){e.preventDefault();var t=e.currentTarget,n=t.value,i=t.selectionStart,u=t.selectionEnd,f=e.which===o?1:-1;e.shiftKey&&(f*=10);var c=l(n,i,u,f);t.value=c.value,t.setSelectionRange(c.start,c.end)}},f=function c(o){return e(o)||o instanceof NodeList?n(o,c):void t(o,"keydown",u,!1)},l=function(e,t,n,o){for(var r,u=e.split(i),f=null,l=null,c=0,a=0;a<u.length;a++)if(r=u[a],c+=r.length,!r.match(i)&&(c>=t&&(null===f&&(f=c-r.length),u[a]=r.replace(/\-?[0-9]+/,parseInt(r.replace(/^.*?(\-?[0-9]+).*/,"$1"),10)+o)),c-=r.length-u[a].length,n-=r.length-u[a].length,c>=n)){l=c;break}return{value:u.join(""),start:f,end:l}};return{eventHandler:u,enable:f,modify:l}});